...
def main():
    ...
    for i in range(num_motions):
        ...
        print("Pick time:", pick_t, "Min distance:", min_dist, "right_hand_pos:", right_hand_pos, "min_y:", min_y)
        if min_dist > 0.15:
