...
trans_new_rev = torch.flip(trans_new.clone(), dims=[0])
quats_new_rev = torch.flip(quats_new.clone(), dims=[0])
joints_new_rev = torch.flip(joints_new.clone(), dims=[0])

trans_new = torch.cat([trans_new, trans_new_rev], dim=0)
quats_new = torch.cat([quats_new, quats_new_rev], dim=0)
joints_new = torch.cat([joints_new, joints_new_rev], dim=0)
