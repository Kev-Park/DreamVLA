...
# CMD="./isaaclab.sh -p scripts/reinforcement_learning/rsl_rl/play_camera.py --task=Isaac-Motion-Tracking-Ground-Pick-Play-v0  --headless --num_envs 1 --device cuda:0 --enable_cameras"
# CMD="./isaaclab.sh -p scripts/reinforcement_learning/rsl_rl/play_camera.py --task=Isaac-Motion-Tracking-Bimanual-Pick-Play-v0  --headless --num_envs 1 --device cuda:0 --enable_cameras --path /home/dvij/isaaclab-sparky/logs/rsl_rl/g1_flat/2025-07-30_11-52-34-bimanual-pick/model_1900.pt"
