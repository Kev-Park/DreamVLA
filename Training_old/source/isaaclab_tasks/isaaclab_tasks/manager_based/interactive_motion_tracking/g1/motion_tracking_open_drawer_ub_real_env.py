...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        rel_pos_goal = ObsTerm(func=rel_pos_goal)
...
class ActionsCfg:
    ...
    right_hand_action = mdp.BinaryJointPositionActionCfg(asset_name="robot",
            ...
            open_command_expr={"right_hand.*": 0., 
                                },
...
@configclass
class G1OpenDrawerUBRealEnvCfg(G1InteractiveBaseEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.ref_motions_path = "../TrajGen/sample/Open_Drawer_real1"
...
@configclass
class G1OpenDrawerUBRealEnvEvalCfg(G1InteractiveBaseEnvCfg):
    rewards: G1Rewards = G1Rewards()
