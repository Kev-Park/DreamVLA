...
@configclass
class JointPositionLowerBodyActionCfg(JointActionCfg):
    """Configuration for the joint position action term.

    See :class:`JointPositionAction` for more details.
    """

    class_type: type[ActionTerm] = joint_actions.JointPositionLowerBodyAction
...
@configclass
class BinaryJointPositionActionFixedCfg(BinaryJointActionCfg):
    """Configuration for the binary joint position action term.
