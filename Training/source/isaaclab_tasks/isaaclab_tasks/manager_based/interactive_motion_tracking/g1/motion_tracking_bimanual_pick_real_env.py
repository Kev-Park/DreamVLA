...
class ObservationsCfg():
    ...
    class PolicyCfg(ObsGroup):
        ...
        target_z = ObsTerm(func=target_z)
...
class MySceneCfg(MySceneCfgBase):
    ...
    platform = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=(0.25+0.5, 0.01, 0.25), rot=(1, 0, 0, 0)),
    ...
    object = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=[0.28, 0.02, 0.63], rot=[1, 0, 0, 0]),
        spawn=sim_utils.CuboidCfg(
            size=(.15, .37, 0.2),collision_props=sim_utils.CollisionPropertiesCfg(),
...
@configclass
class G1BimanualPickRealEnvCfg(G1InteractiveBaseEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.ref_motions_path = "../TrajGen/sample/Bimanual_Pick_real"
...
@configclass
class G1BimanualPickRealEnvPlayCfg(G1InteractiveBaseEnvCfg):
    rewards: G1Rewards = G1Rewards()
    events: EventCfg = EventCfg()
    observations: ObservationsCfg = ObservationsCfg()
    scene: MySceneCfg = MySceneCfg(num_envs=8192, env_spacing=2.5)
