...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        target_z_val = ObsTerm(func=target_z)


        hand_state_target_val = ObsTerm(func=hand_state_target)
        hand_state_target_val_1 = ObsTerm(func=hand_state_target_1)
...
@configclass
class G1SquatRealEnvCfg(G1InteractiveBaseEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.ref_motions_path = "../TrajGen/sample/Squat_real2"
...
@configclass
class G1SquatRealEnvPlayCfg(G1InteractiveBaseEnvCfg):
    rewards: G1Rewards = G1Rewards()
    observations: ObservationsCfg = ObservationsCfg()
    terminations: TerminationsCfg = TerminationsCfg()
    actions: ActionsCfg = ActionsCfg()
