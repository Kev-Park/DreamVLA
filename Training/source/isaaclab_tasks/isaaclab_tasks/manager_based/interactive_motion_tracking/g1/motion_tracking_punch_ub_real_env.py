...
@configclass
class G1PunchUBRealEnvCfg(G1InteractiveBaseEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.ref_motions_path = "../TrajGen/sample/Punch_real2"
...
@configclass
class G1PunchUBRealEnvEvalCfg(G1InteractiveBaseEnvCfg):
    rewards: G1Rewards = G1Rewards()
