...
class ActionsCfg(ActionsCfgBase):
    ...
    right_hand_action = mdp.BinaryJointPositionActionCfg(asset_name="robot",
            ...
            open_command_expr={"right_hand_index_.*": 0., 
                                "right_hand_middle_.*": 0.,
...
@configclass
class G1SquatOpenDrawerRealEnvCfg(G1InteractiveBaseEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.ref_motions_path = "../TrajGen/sample/Squat_Open_Drawer_real"
...
@configclass
class G1SquatOpenDrawerRealEnvPlayCfg(G1InteractiveBaseEnvCfg):
    rewards: G1Rewards = G1Rewards()
    observations: ObservationsCfg = ObservationsCfg()
    terminations: TerminationsCfg = TerminationsCfg()
    actions: ActionsCfg = ActionsCfg()
