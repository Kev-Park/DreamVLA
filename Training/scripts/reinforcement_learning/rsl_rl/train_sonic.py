...
parser = argparse.ArgumentParser(description="Train a SONIC encoder vs. frozen decoder with RSL-RL.")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    """Train a SONIC encoder against the frozen SONIC decoder with RSL-RL."""
